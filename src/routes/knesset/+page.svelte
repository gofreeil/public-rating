...
<svelte:head>
    <title>דירוג חברי כנסת ושרים — דירוג ציבורי</title>
    <meta
        name="description"
        content="דרגו את חברי הכנסת והשרים: עמידה בזמנים ובתקנים, תרומה לעם, חזון ושקיפות. דירוג ציבורי אמיתי מהאזרחים."
    />
</svelte:head>
