...
import { getApprovedAdImage, isAdImageKind } from '$lib/server/ads';
import { immutableImageResponse } from '$lib/server/inlineImage';

/**
 * תמונות המודעות - במקום base64 מוטבע בנתונים שנשלחים לדפדפן.
 *
 ...
 *
 * מוגש ממודעות מאושרות בלבד, כך שתמונות של מודעה ממתינה/נדחית אינן
